...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //to handle creation of new user
    ...
    private void createAccount(){
        ...
        //in case if user not give any input
    ...
    private void validatePhoneNumber(final String name, final String phone, final String password) {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    if(task.isSuccessful()){
                                        Toast.makeText(RegisterActivity.this, "Congratulations, your account is registered SUCCESSFULLY", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();
                ...
                //in case phone number is already in database
                else{
