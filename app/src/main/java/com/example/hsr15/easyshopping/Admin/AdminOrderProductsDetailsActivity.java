...
public class AdminOrderProductsDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_order_products_details);

        userID = getIntent().getStringExtra("uid");

        productsList = findViewById(R.id.products_recycler_view);
